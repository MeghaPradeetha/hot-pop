@php
    ...
    \Navigator::addItem(
        [
            ...
            'resource' => 'manage.interests.index',
        ],
        'sidebar.manage',
    );
    ...
    \Navigator::addItem(
        [
            ...
            'icon_class' => 'fas fa-circle',
            'resource' => 'manage.subs-plans.index',
        ],
        'sidebar.manage',
    );
    ...
    \Navigator::addItem(
        [
            'text' => 'Nationality',
            'icon_class' => 'fas fa-circle',
            'resource' => 'manage.nationality.index',
        ],
        'sidebar.manage',
    );
    ...
    \Navigator::addItem(
        [
            'text' => 'Early Acces Data',
            'icon_class' => 'fas fa-table',
            'resource' => 'manage.early-access-data',
        ],
        'sidebar.manage',
    );
