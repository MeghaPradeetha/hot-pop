                ...
                <div class="container py-4 py-lg-5">
                    <div class="form-card p-4">
                        <div class="header-bar position-relative mb-4">
                            <h3 class="headingH2">{{ $profile->name }}</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="">
                                    <div class="video-bg position-relative w-100">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/'.$profile->avatar) }}" style="object-fit: cover;height: 100%;width: 100%;" />
                                        @endif
                            ...
                            <div class="col-lg-5 p-t-24 position-relative">
                                <h2 class="headingH2 pb-1">{{ $profile->full_name }}</h2>
                                <p class="d2 p-b-24"><i class="fa fa-map-marker-alt me-2"></i> {{ $profile->location }}</p>
                                <p class="p-b-24">{{ $profile->personality->nationality ?? 'N/A' }} | {{ $profile->age ?? 'N/A' }} Years |
                                    {{ $profile->personality->occupation ?? 'N/A' }}</p>

                                <p class="headingH3 pb-3">{{ $profile->avatar_path }}</p>
                                @if ($interests != null)
						...
						<label><span class="icon-check-label">🏝️ Travel</span></label> --}}
                                ...
                                <div class="personality-card">
                                    ...
                                    <p class="fw-bold">{{ $profile->personality->relationship_type ?? 'N/A' }}</p>
                                </div>
                                <div class="personality-card">
                                    ...
                                    <p class="fw-bold">{{ $profile->personality->height ?? 'N/A' }}</p>
                                </div>
                                <div class="personality-card">
                                    ...
                                    <p class="fw-bold">{{ $profile->personality->nationality ?? 'N/A' }}</p>
                                </div>
                                <div class="personality-card">
                                    ...
                                    <p class="fw-bold">{{ $profile->personality->hometown ?? 'N/A' }}</p>
                                </div>
                                <div class="personality-card">
                                    ...
                                    <p class="fw-bold">{{ $profile->personality->like_to_have_more_childran ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
