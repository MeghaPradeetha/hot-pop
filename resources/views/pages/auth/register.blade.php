                ...
                <div class="form-card p-200">
                    <div class="header-card text-center">
                        ...
                        <div class="d-flex tab-bar">
                            <a class="w-50 active" href="{{ route('register') }}">
                                Register
                            </a>
                            <a class="w-50" href="{{ route('login') }}">
                                Login
                            </a>
                        </div>
                        <p class="p-t-32 p-b-24 f-16">Please add your information below to create your account today. </p>
                    </div>
                    <div class="">
                        <form action="{{ route('register.store') }}" class="p-t-40" method="POST">
                            @csrf
                            <div class="p-b-24">
                            ...
                            <div class="p-b-24">
                                ...
                                <input class="form-control form-text" id="phone" name="phone" placeholder="Type your phone number here" type="text">
                            </div>
                            <div class="p-b-24">
                            ...
                            <div class="p-b-24">
                                ...
                                <div class="icon-container">
                                    <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} form-text" id="password_confirmation" name="password_confirmation"
                                        placeholder="Confirm your password here" required type="password">
                                    <a onclick="togglePasswordVisibility('password_confirmation')">
                                        <i class="fa fa-eye-slash icon-over" id="password_confirmation_img" style="color:black;"></i>
                                    </a>
                            ...
                            <p class="text-center f-16 p-t-24 p-b-50">
                                By registering with HOT POP you agree to our <a class="a1" href="/terms-and-conditions">Terms & Conditions</a> and <a class="a1"
