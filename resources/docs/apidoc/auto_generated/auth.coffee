...
@apiParam {String} [apn_key_token] nique apn token for the device
...
@apiParam {String} device_type Type of the device `APPLE` or `ANDROID`
@apiParam {String} [device_push_token] Unique push token for the device
@apiParam {String} [apn_key_token] Unique apn token for the device
...
###
@apiVersion 1.0.0
@api {POST} api/v1/push-token/update Push Token Update
@apiGroup Auth
@apiParam {String} [device_push_token] Unique push token for the device
@apiParam {String} [apn_key_token] Unique apn token for the device
@apiUse default_headers
