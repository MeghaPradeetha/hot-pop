		...
		Route::group(['middleware' => ['auth', 'auth.acl:roles[super-admins|admins|developers]']], function ()
		{
			...
			Route::group(['prefix' => 'account'], function ()
			{
				...
				], function ()
				{
					...
					//Route::get('/profile-home' , 'HomeController@index')->name('home-profiles');
					// Route::resource('users', 'ManageUsersController')->only('index','store', 'edit', 'update', 'destroy');
					// // Route::get('users/{user}/edit-password', 'ManageUsersController@editPassword')
					// 	->name('users.edit-password');
					// Route::put('users/{user}/edit-password', 'ManageUsersController@updatePassword');
					// Route::put('users/{user}/update-disabled', 'ManageUsersController@updateDisabled')
					// 	->name('users.update-disabled');
				});
			});
		});
